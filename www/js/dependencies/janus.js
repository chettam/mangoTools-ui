/**
 * Created by jbblanc on 05/10/2015.
 */
// List of sessions
Janus.sessions = {};
...
Janus.isWebrtcSupported = function() {
    if(window.webkitRTCPeerConnection === null || window.navigator.webkitGetUserMedia === null) {
        return false;
    }
    return true;
};
...
function Janus(gatewayCallbacks) {
    ...
    function streamsDone(handleId, jsep, media, callbacks, stream) {
        ...
        config.pc = new window.webkitRTCPeerConnection(pc_config, pc_constraints);
        Janus.log(config.pc);
    ...
    function prepareWebrtc(handleId, callbacks) {
        ...
        if(isAudioSendEnabled(media) || isVideoSendEnabled(media)) {
            ...
            if(videoSupport === true && media != undefined && media != null) {
                if(media.video && media.video != 'screen') {
                    ...
                    function getScreenMedia(constraints, gsmCallback) {
                        ...
                        window.navigator.webkitGetUserMedia(constraints,
                            function(stream) {
            ...
            // No need to do a window.navigator.webkitGetUserMedia, create offer/answer right away
